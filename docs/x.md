...
`focus`, `reasoning_effort`, `limit`, the window, and `capture` all change cost, latency, and what comes back. If you want the agent to propose settings and wait for your OK first:
